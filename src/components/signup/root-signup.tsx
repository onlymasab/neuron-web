...
function RootSignUp({ onClose }: SignUpProps) {
    return (
        <section className="flex flex-col justify-center px-8 pt-3 pb-8 gap-4 bg-white rounded-xl border border-solid border-zinc-300 max-w-[440px] shadow-[0px_0px_48px_rgba(0,0,0,0.15)]">
            <header className="flex flex-col items-center w-full">
                <button className="self-end -mr-4" onClick={onClose}>
                ...
                <h1 className="mt-2 text-xl font-semibold tracking-normal leading-snug text-black">
                    Create your account
                </h1>
                <p className="mt-3 text-xs font-medium tracking-normal leading-4 text-center text-[#808080]">
                    Looks like you don't have an account with us. We'll create one for you using example@email.com.
                </p>
                <Image src={"/images/signup_img.png"} alt="Signup" width={192} height={192} />
            </header>
