      ...
      <h2 className="text-2xl font-medium pt-[4vh]">Recycle bin</h2>
      {
        !data.length ? (
          <div className="flex flex-col h-full">
            <div className="flex w-full gap-4 justify-between items-center py-[clamp(1vh,1.5vh,2vh)] max-2xl:pl-8 px-6 bg-white rounded-md">
              ...
              <div className="flex flex-1 gap-3 items-center">
                <span className="text-sm 2xl:text-lg font-medium">Delete Date</span>
                <ChevronIcon />
              </div>
              <div className="flex flex-1 gap-3 items-center">
            ...
            <div className="flex flex-col gap-[4vh] items-center my-auto">
              <div className="size-[11vw]">
              <RecycleIcon />
              </div>
